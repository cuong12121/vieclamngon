            ...
            <div class="w190laor">
                ...
                <div class="WrapperScroll_wrapperOverflow__BptX1">
                    <div class="styles_oneRowContent__yddIy wflw9x5" style="--wflw9x5-0: 0;">
                        ...
                        <li class="slider-item i1jeubyn" style="width: 96px;">
                            <a aria-label="Tài xế giao hàng xe máy" href="#" class="apx1hlq">
                        ...
                        <li class="slider-item i1jeubyn" style="width: 96px;">
                            <a aria-label="Phụ bếp" href="#" class="apx1hlq">
                        ...
                        <li class="slider-item i1jeubyn" style="width: 96px;">
                            <a aria-label="Nhân viên kinh doanh" href="#" class="apx1hlq">
                        ...
                        <li class="slider-item i1jeubyn" style="width: 96px;">
                            <a aria-label="Công nhân" href="#" class="apx1hlq">
                        ...
                        <li class="slider-item i1jeubyn" style="width: 96px;">
                            <a aria-label="Nhân viên kho vận" href="#" class="apx1hlq">
                        ...
                        <li class="slider-item i1jeubyn" style="width: 96px;">
                            <a aria-label="Bảo vệ" href="#" class="apx1hlq">
                                <div class="c14xr536">
